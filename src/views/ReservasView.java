...
//        JLabel lblCheckIn = new JLabel("FECHA DE ENTRADA"); //OJO CON ESTE CAMBIO, ESTAN INVERTIDOS
...
//        panel.add(lblCheckOut);
        ...
        JLabel lblCheckOut = new JLabel("FECHA DE SALIDA"); //OJO CON ESTE CAMBIO, ESTAN INVERTIDOS
        lblCheckOut.setForeground(SystemColor.textInactiveText);
        lblCheckOut.setBounds(68, 221, 187, 14);
        lblCheckOut.setFont(new Font("Roboto Black", Font.PLAIN, 18));
        panel.add(lblCheckOut);
        ...
        lblValorSimbolo.setBounds(130, 332, 27, 25);
    ...
    private void guardarReserva() {
        ...
        if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null && !txtValor.equals("") && !txtFormaPago.getSelectedItem().toString().equals("")) {
            ...
            if (inicio.before(fin) || inicio.equals(fin)){
                ...
                RegistroHuesped registro = new RegistroHuesped(reserva.getId());    //ESTUDIAR
                registro.setVisible(true);
                dispose();
            }else{
                JOptionPane.showMessageDialog(null, "La fecha de entrada no debe ser mayor que la fecha de salida", "Error de fecha", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public void calcularValor(JDateChooser dataE, JDateChooser dataS) {
        if (dataE.getDate() != null && dataS.getDate() != null) {
            ...
            while (inicio.before(fin) || inicio.equals(fin)) {
                dias++;
                inicio.add(Calendar.DATE, 1);        // Se incrementa la fecha inicio en 1 día en cada iteración del bucle para avanzar al siguiente día.
            }
            valor = dias * noche;
    ...
    //ESTO ES PARA CUANDO ACTUALICEMOS LAS FECHAS DE LA TABLA, SE LIMPIE EL VALOR

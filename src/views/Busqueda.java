...
public class Busqueda extends JFrame {
        ...
        btnEliminar.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                if (filaReservas >= 0) {
                    ...
                    int confirmaH = JOptionPane.showConfirmDialog(null, "Dsea Borrar al huesped?");
    ...
    private List<Reserva> MostrarReservas() {
        return this.reservasControl.mostar();
    }
    ...
    private void ActualizarReservas() {
        Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn())).ifPresent(fila -> {
            ...
            //PARA QUE POR ERROR NO CAMBIEMOS LOS IDS
            if (tbReservas.getSelectedColumn() == 0) {
                JOptionPane.showMessageDialog(this, "No se puede editar los ID");
            } else {
                this.reservasControl.actualizarReserva(id, dataE, dataS, valor, formaPago);
    ...
    private List<Huespedes> mostrarHuespedes() {
        return this.huespedControl.mostarHuesped();
    }
    ...
    private void actualizarHuespedes(){
        Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
                .ifPresentOrElse(filaHuespedes ->{
                    ...
                    java.sql.Date fechaNacimiento = Date.valueOf(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(),3).toString());
                    ...
                    JOptionPane.showMessageDialog(this, String.format("Registro modificado con exito!"));}
                }, ()-> JOptionPane.showInternalMessageDialog(this,"Por favor no seas animal :)"));
    }
